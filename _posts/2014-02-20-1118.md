...
### 配置 git 关联 github ###
##### 在 Github 上创建项目
* 登录 github，访问 https://github.com/new 创建一个项目，
...
```
##### 使用 SSH Key
* 为了不用每次都输入密码，我们需要使用 SSH Key ，这个在 github 官网有介绍，这里就不再赘述了，地址：https://help.github.com/articles/generating-ssh-keys
...
* 修改`ruby gem`的资源地址，详见 http://ruby.taobao.org/
...
```
* 参照官网 http://jekyllbootstrap.com/usage/jekyll-quick-start.html 
```
...
jekyll serve
```
可以在本地运行 jekyll ，这样我们就可以通过 http://127.0.0.1:4000 在本地查看博客效果了，本地预览没有问题之后再发布，很方便。
...
```
文件会被创建到 `_post` 目录下，而且文件名是有固定格式的，我们可以参照这里 http://jekyllrb.com/docs/permalinks/ 来修改文件名格式。
...
### 本地预览
只需要重启 jekyll 服务就可以了，然后刷新 http://127.0.0.1:4000
...
* http://www.cnblogs.com/subying/p/window-git-shell-proxy-ssl-error.html
* http://rangercyh.blog.51cto.com/1444712/749490
* http://www.worldhello.net/2010/11/30/2166.html	
#### jekyll
* http://jekyllrb.com/docs/home/
* http://www.madhur.co.in/blog/2011/09/01/runningjekyllwindows.html
* http://aiku.me/bar/101235902
* http://qjw.qiujinwu.com/blog/2012/10/07/Windows\_jekyll/
* http://blog.jsfor.com/skill/2013/09/07/jekyll-local-structures-notes/
* http://stackoverflow.com/questions/7395520/how-does-jekyll-date-formatting-work
#### jekyll bootstrap
